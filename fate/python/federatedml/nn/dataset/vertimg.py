...
from federatedml.nn.dataset.segmentation.vertutils import SegmentationImage, get_transform
from federatedml.nn.dataset.segmentation import image_transforms

from federatedml.util import LOGGER


class VertSegImg(Dataset):
    ...
    def __init__(self, center_crop=False,
        ...
        super(VertSegImg, self).__init__()
        self.segmentations: SegmentationImage = None
